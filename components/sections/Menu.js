...
const Menu = () => {
    return (
        <section className="bg-[#F5E5F5] py-12 md:py-20">
            <style jsx global>{`
            ...
            <div className="max-w-[1440px] mx-auto px-4 md:px-8 xl:px-[100px]">
                <h2 className="font-playfair font-playfair-semibold text-3xl sm:text-4xl lg:text-[47px] text-solid text-center text-solid mb-6 md:mb-12">
                    ...
                    {menuItems.map((item, index) => (
                        <SwiperSlide key={index} className="h-auto">
                            <div className="h-full relative bg-[#fff6ff] rounded-2xl overflow-hidden p-8 flex flex-col items-center text-center">
                                ...
                                {/* Main Menu Image */}
                                <div className="w-[120px] h-[120px] md:w-[160px] md:h-[160px] relative mb-6 z-10">
                                    <Image
                                        src={item.image}
                                        alt={item.title}
                                        fill
                                ...
                                {/* Title */}
                                <h3 className="font-playfair font-semibold text-lg md:text-xl text-[#5E315E] mb-2 z-10">
                                    {item.title}
                                </h3>

                                <hr className="border-dotted border-[#5E315E]/50 w-full mb-4 z-10" />

                                {/* Description */}
                                <p className="text-[#5E315E]/90 font-lato font-normal text-sm md:text-base leading-[1.6] z-10">
                                    {item.description}
                                </p>
                            </div>
                        </SwiperSlide>
